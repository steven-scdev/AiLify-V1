      ...
      <div className="self-stretch flex flex-col items-start justify-center py-[393px] px-0">
        <div className="self-stretch h-[318px] flex flex-col items-center justify-start gap-[23px]">
          ...
          <div className="self-stretch overflow-hidden flex flex-col items-start justify-start gap-[1px] text-lg font-inter">
            <div className="w-full flex flex-col items-start justify-start py-0 pr-4 pl-0 box-border max-w-[380px]">
              <div className="w-full relative leading-[28px] inline-block max-w-[380px]">
                <p className="m-0">Empower Your Business with Cutting-Edge</p>
                <p className="m-0">AI Solutions</p>
              </div>
            </div>
            <div className="self-stretch h-[88px] flex flex-row items-start justify-start pt-5 pb-0 pr-[1030.93994140625px] pl-0 box-border gap-[12px]">
              <div className="self-stretch flex flex-col items-start justify-start pt-0 px-0 pb-0.5">
                <button className="cursor-pointer [border:none] py-3 pr-[31.031455993652344px] pl-[31.858543395996094px] bg-darkorange self-stretch rounded-lg flex flex-row items-start justify-start">
              ...
              <button className="cursor-pointer [border:none] p-0 bg-[transparent] self-stretch flex flex-col items-start justify-start">
                <div className="self-stretch rounded-lg bg-white shadow-[0px_1px_2px_rgba(16,_24,_40,_0.05)] flex flex-row items-start justify-start py-[13px] pr-[31.322864532470703px] pl-[32.84713363647461px] border-[1px] border-solid border-gray-100">
